  ...
  <div class="_setting">
    ...
    <div class="d-flex align-items-center justify-content-center _wizard mt-3">
      <div :class="this.wizardIndex === 0 ? '' : 'animate__fadeOutRight hide'">
        ...
        <p :class="this.wizardIndex === 2 ? 'hide' : '_help mt-3'">
          Get token for the EBSI<br />Pre Production environment
          <span
            ><a
              href="https://app.preprod.ebsi.eu/users-onboarding"
              target="_blank"
              >here</a
            ></span
          >
