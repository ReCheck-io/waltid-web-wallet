<template>
  <div>
    ...
    <div>
      <video
        id="scanner-video"
        class="image-fluid mx-auto img-thumbnail"></video>
      <em>{{ progressMsg }}</em>
    </div>
  </div>
</template>
  ...
  methods: {
    checkScanResult(result) {
      try {
        ...
        return (
          resultObject != null &&
          resultObject.contract != null &&
          resultObject.contract.address != null &&
          resultObject.id != null &&
          resultObject.id.tokenId != null &&
          resultObject.metadata != null &&
          resultObject.metadata.image != null
        )
      } catch (error) {
